...
def actualizar_pantalla(texto):
    ...
    display(str(jugador.nivel), target="nivel")
    display(f"{jugador.experiencia}/{jugador.exp_para_subir}", target="exp")
    display(str(jugador.oro), target="oro")
    display(f"{len(jugador.inventario)} items", target="inventario")
